...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${contextPath}/scripts/jquery.validate.min.js" charset="utf-8"></script>
		<link rel="stylesheet" href="${contextPath}/styles/forms-new.css" type="text/css"/>
		<style type="text/css">
			#signupForm {
				width: 640px;
			}
	...
	<body>
		<div id="container-page">
			<div class="popDiv">
				...
				<div id="formContent">
					<form class="cmxform" id="signupForm" method="get" action="${contextPath}/demos3/large_thx.jsp">
						<fieldset>
