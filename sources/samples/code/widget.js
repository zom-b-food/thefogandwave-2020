...
$().ready(function () {
    $("#btnUpdate").live("click", function () {
        ...
        $('#select2 option').map(function () {
            return $('<div/>', {class: 'iframe cboxElement' + ' ' + $(this).text(), id: 'enableProfiles' + $(this).text(), style: '', href: './includes/profile' + $(this).text() + '.jsp', text: $(this).text()}).get(); // or this.value / $(this).val()
        }).appendTo('#newProf');
