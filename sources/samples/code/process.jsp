		...
		<script type="text/javascript">
			function redir() {
				...
				if ((name == "guest" ) && (email == "guest@home.com" )) {
					document.showGallery.action = "${contextPath}/gallery/amber/home.jsp";
				}
				<!--new port -->
				else if ((name == "ironic" ) && (email == "adam.marsh@sotto.com" )) {
					{
						document.showGallery.action = "${contextPath}/gallery/johnson/home.jsp";
					}
				}
				...
				<!--port new -->
					...
					document.showGallery.action = "${contextPath}/gallery/login.jsp";
				}
