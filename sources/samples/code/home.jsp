...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="change()">
		<div id="splash-page">
			<div id="topPortion">
				<%@ include file="./inc/flashTop.jsp" %>
			</div>
			<div class="splash">
				<div class="resSep">&nbsp;&nbsp;<a href="${contextPath}/sources/almResume.zip" class="main">&nbsp;&#187;&nbsp;Download
					Resume</a>&nbsp;&nbsp;|
					<a class="standard" href="${contextPath}/samplesites/samplecode/codes.jsp"> &nbsp;&#187;&nbsp;View
						Code Samples</a>&nbsp;&nbsp;|<a
							class="samples" href="${contextPath}/samplesites/ghcHOME.jsp"> &nbsp;&#187;&nbsp; View
						Project Samples</a>&nbsp;&nbsp;|
					<a id="none" class="main" href="${contextPath}/sources/samples.zip">&nbsp;&#187;&nbsp;Download Code
						Samples</a>
				</div>
				<div class="leftColWide"><h1>Adam L. Marsh</h1>
					<img src="${contextPath}/images/rule.gif" alt="" width="346" height="9"/> <br/>
				...
				<div class="summary">
					...
					<p class="subhead"><img src="${contextPath}/images/rule2.gif" alt="" width="10"
					                        height="7"/>&nbsp;<strong>Work
						History</strong>&nbsp;<img src="${contextPath}/images/rule2.gif" alt="" width="30" height="7"/>
					</p>
					...
					<p class="subhead"><img src="${contextPath}/images/rule2.gif" alt="" width="10"
						...
						URLs</strong>&nbsp;<img src="${contextPath}/images/rule2.gif" alt="" width="30" height="7"/></p>
					...
					<div class="leftResCol">
						<ul class="fancybulletBig">
							...
							<li><a href="${contextPath}/samplesites/ghcHOME.jsp" class="samples">www.ghc.org</a></li>
							<li><a href="${contextPath}/samplesites/hiltonHOME.jsp" class="samples">www.hilton.com</a>
							</li>
						</ul>
					</div>
					<div class="rightResCol">
						<ul class="fancybulletBig">
							<li><a href="${contextPath}/samplesites/sottoHOME.jsp"
							       class="samples">www.sottowireless.com</a></li>
							<li><a href="${contextPath}/samplesites/attHOME.jsp" class="samples">www.attwireless.com</a>
							</li>
							<li><a href="${contextPath}/samplesites/msHOME.jsp" class="samples">www.microsoft.com/executivecircle</a>
							</li>
						</ul>
					</div>
					<br clear="all"/>
					...
					<p class="subhead"><img src="${contextPath}/images/rule2.gif" alt="" width="10"
						...
						&amp; Training</strong>&nbsp;<img src="${contextPath}/images/rule2.gif" alt="" width="30"
					                                      height="7"/></p>
